...
export default class MasterHog extends Component {
  ...
  generateBabies = (pigArray) => {
    return pigArray.map(babyPig => {
      //creating props here
      return <BabyHog name={babyPig.name} hobby={babyPig.hobby} eyeColor={this.state.eyeColor} />
    })
  }
